...
namespace DockingMap
{
    ...
    ///</summary>
    public class GMapPathGeometryWriter
    {
        /**
         ...
         */
        public static readonly IPointToPathGeometryFactory DefaultPointFactory = new SquarePath(0.1);
        ...
        {
            var viewPoint = new WpfPoint(point.Coordinate.Y, point.Coordinate.X); //TransformPoint(point.Coordinate);
        ...
        {
            var resPoint = new WpfPoint(coords[0].Y, coords[0].X);// TransformPoint(coords[0]);
            var prev = coords[0];
            ...
            for (var i = 1; i <= n; i++)
            {
                ...
                var tmpPoint = new WpfPoint(coords[i].Y, coords[i].X);// TransformPoint(coords[i]);
