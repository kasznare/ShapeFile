...
namespace ShapefileEditor
{
    ...
    public class GMapGeometryReader
    {
        ...
        {
            var pc = new GMapGeometryReader(geomFact);
        ...
        public GMapGeometryReader(IGeometryFactory geometryFactory, bool invertY = false)
            :this(geometryFactory, invertY ? InvertY : Matrix.Identity) { }

        public GMapGeometryReader(IGeometryFactory geometryFactory, Matrix transform)
        {
        ...
        private Coordinate ToCoordinate(WpfPoint point)
        {
            ...
            return new Coordinate(transformedPoint.Y, transformedPoint.X);
        }
    }
}